            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <a href="{{ route('owner.properties') }}" class="block p-4 bg-amber-50 rounded-lg hover:bg-amber-100 transition text-center">
                            <svg class="h-8 w-8 text-amber-600 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                            </svg>
                            <span class="font-medium text-amber-700">View Properties</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            datasets: [{
                ...
                data: [
                    @foreach($monthlyRevenueData ?? [] as $month => $revenue)
                        {{ $revenue }},
                    @endforeach
                    // If $monthlyRevenueData isn't provided, use placeholder data
                    @if(!isset($monthlyRevenueData))
                        {{ rand(1000, 3000) }}, {{ rand(1000, 3000) }}, {{ rand(1000, 4000) }}, 
                        {{ rand(2000, 4000) }}, {{ rand(2000, 5000) }}, {{ rand(3000, 6000) }},
                        {{ rand(4000, 7000) }}, {{ rand(3000, 6000) }}, {{ rand(2000, 5000) }},
                        {{ rand(2000, 4000) }}, {{ rand(1000, 3000) }}, {{ $monthlyRevenue ?? rand(2000, 5000) }}
                    @endif
                ],
                fill: true,
                tension: 0.4
